...
public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        //Expression 3 (if all the numbers in an expression are integers, the final outcome will also be an integer because the computer will cut out the rest of the decimal. If
        //don't want this to happen, simply put .0 after the number so that it is no longer an integer and the computer will give you the correct output
